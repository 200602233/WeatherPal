...
import com.example.weatherpal.databinding.SearchItemLayoutBinding;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        SearchItemLayoutBinding binding =
                SearchItemLayoutBinding.inflate(LayoutInflater.from(parent.getContext()), parent,
                        false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        SearchItemLayoutBinding binding; //binds for the search_item_layout.xml
...
//        ImageView weatherIcon;
        ...
        public MyViewHolder(SearchItemLayoutBinding binding) {
