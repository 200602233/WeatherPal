...
//        });
    ...
    private void retrieveSavedCities(){
        ...
        if (user != null) {
            ...
            WeatherRepository.INSTANCE.retrieveSavedCities(
                    uid,
                    savedCities -> {
                        weatherList.clear();
                        weatherList.addAll(savedCities);
                        ...
                        // used ai to figure out INSTANCE
                        return Unit.INSTANCE;
                        },
                    () -> {
                        Toast.makeText(requireContext(), "Failed to retrieve cities", Toast.LENGTH_SHORT).show();
                        return Unit.INSTANCE;
                    }
            );
    ...
    public void unsaveCity(View v, int pos){
        ...
        if (user != null) {
            ...
            WeatherRepository.INSTANCE.unsaveCity(
                    ...
                    () -> {
                        Toast.makeText(requireContext(), "Failed unsaving city!", Toast.LENGTH_SHORT).show();
                        return Unit.INSTANCE;
                    }
                    );
        } else{
